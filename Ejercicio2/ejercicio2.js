...
function calcular(){
    ...
    nuevoNodo.innerHTML = "<br><p class=\"tipoFuente text-light fs-5 centrartexto\">La longitud de la circunferencia de radio <b class=\"\">" + radio + "</b> es: <b class=\"fs-3\">" + circunferencia.toFixed(2) + "</b></p>";
    nuevoNodo2.innerHTML = "<p class=\"tipoFuente  text-light fs-5 centrartexto\">El área del círculo de radio <b class=\"\">" + radio + "</b> es: <b class=\"fs-3\">" + circulo.toFixed(2) + "</b></p>";;
    nuevoNodo3.innerHTML = "<p class=\" tipoFuente text-light fs-5 centrartexto\">El volumen de la esfera de radio <b class=\"\">" + radio + "</b> es: <b class=\"fs-3\">" + esfera.toFixed(2) + "</b></p>";;
